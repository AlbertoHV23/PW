<%-- 
    Document   : Volveracrear
    Created on : 18/11/2020, 03:48:02 PM
    Author     : alber
--%>
  ...
  <body>
    ...
    <main>
        <div class="container crear">
          ...
          <form class="mb-3 mt-3" action="./VolveraCrear"  method="POST">
           ...
           <input type="password" name="id_noti" id="password" value="<%=noticia.getId_noticia()%>"
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="video" value="<%=noticia.video%>"  id="video" placeholder="Example: https://www.youtube.com/watch?v=-au1ZG2BnyU">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1">Title of the news:</label>
              <input type="text" class="form-control" value="<%=noticia.getTitulo()%>"  name="titulo" id="titulo" placeholder="Title">
            </div>
            <div class="form-group">
              <label for="exampleFormControlSelect1">Category:</label>
              <select class="form-control" id="categoria" value="<%=noticia.getCategoria()%>"  name="categoria">
                 <%for(tbl_categoria cat : categoria){%>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="des_corta"  id="des_corta" rows="3"><%=noticia.getDescripcion_larga()%></textarea>
            </div>
            <div class="form-group">
              <label for="FormControlTextarea2">Long description:</label>
              <textarea class="form-control" name="descripcion"  id="descripcion" rows="3"><%=noticia.getDescripcion_corta()%></textarea>
            </div>
