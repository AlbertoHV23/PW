<%-- 
    Document   : editor
    Created on : 7/11/2020, 05:45:27 PM
    Author     : geraj
--%>
              ...
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="#">Notifications<span class="badge badge-light">5</span></a>
                    <a class="dropdown-item" href="#">Allow<span class="badge badge-light">10</span></a>
