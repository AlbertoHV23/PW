 ...
 * @author alber
 */
@WebServlet(name = "Bloquear", urlPatterns = {"/Bloquear"})
public class Bloquear extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if(usuario.getRol().equals("Moderador")){
              ...
              int _id_usu = Integer.parseInt(id_usuario);
              noticiaDAO.BorrarComentarios_comentarios(_id_comentario);
              noticiaDAO.BorrarComentarios(_id_comentario);
              noticiaDAO.BanearUsuario(_id_usu,false);
