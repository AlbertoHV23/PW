...
public class tbl_noticia {
    ...
    public tbl_noticia(int id_noticia, String titulo, String descripcion_corta, String descripcion_larga, String fecha, String hora, boolean aprovado, int valoracion_like, int valoracion_Nolike, String usuario, String categoria, List<tbl_imagenes> imagenes, String video) {
      ...
      public tbl_noticia(int id_noticia, String titulo, String descripcion_corta, String descripcion_larga, String fecha, String hora, boolean aprovado, int valoracion_like, int valoracion_Nolike, String usuario, String categoria, List<tbl_imagenes> imagenes, String video, String comentario) {
        this.id_noticia = id_noticia;
        this.titulo = titulo;
        this.descripcion_corta = descripcion_corta;
        this.descripcion_larga = descripcion_larga;
    ...
    public tbl_noticia(int id_noticia, String titulo, String descripcion_corta, String descripcion_larga, String fecha, String hora, boolean aprovado, int valoracion_like, int valoracion_Nolike, List<tbl_imagenes> imagenes, String video) {
        this.id_noticia = id_noticia;
        this.titulo = titulo;
        this.descripcion_corta = descripcion_corta;
        this.descripcion_larga = descripcion_larga;
