 ...
 * @author alber
 */
@WebServlet(name = "EditarNoticia", urlPatterns = {"/EditarNoticia"})
public class EditarNoticia extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if(usuario == null){ //si no hay una session activa
             ...
             String aprovar = request.getParameter("ID");
             if(aprovar != null){
             int id_noticia = Integer.parseInt(aprovar);
                 noticiaDAO.Aprovar(id_noticia); 
             }
